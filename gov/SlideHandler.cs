...
namespace gov
{
    ...
    public static class SlideHandler
    {
        ...
        private static string SlideUseChrome1(string companyName)
        {
            const string url = "http://www.gsxt.gov.cn/index.html";
        ...
        {
            Console.WriteLine($"{Environment.GetFolderPath(Environment.SpecialFolder.Desktop)}\\chromeDriverData");
        }
    }
}
